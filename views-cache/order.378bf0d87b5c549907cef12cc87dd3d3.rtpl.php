...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/pqdt/orders">Pedidos</a></li>
        <li class="active"><a href="/pqdt/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Pedido N°<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
    </ol>
    </section>
    ...
    <section class="invoice">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <button type="button" onclick="window.location.href = '/pqdt/orders/<?php echo htmlspecialchars( $order["idstatus"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status'" class="btn btn-default pull-left" style="margin-left: 5px;">
