							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<!-- rádio paypal-->
										<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											<input type="radio" checked id="method-paypal" name="payment-method" value="2" style="float:left; margin:30px;">
											<label class="" for="method-paypal"><img style="height:64px;" src="/res/site/img/logo-paypal.png"></label>
										</p>

										<!-- rádio boleto-->
										<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											<input type="radio" id="method-boleto" name="payment-method" value="3" style="float:left; margin:30px;">
											<label class="" for="method-boleto"><img style="height:64px;" src="/res/site/img/boleto.png"></label>
										</p>
